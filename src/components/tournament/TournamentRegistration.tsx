        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <p className="font-medium">Entry Fee: {tournament.entry_fee || 'Free'}</p>
          ...
          <CardContent className="space-y-3">
            {roomDetails.room_id && (
              <div>
                ...
                <p className="font-mono text-lg">{roomDetails.room_id}</p>
              </div>
            )}
            {roomDetails.room_password && (
              <div>
                <p className="text-sm font-medium text-muted-foreground">Password</p>
                <p className="font-mono text-lg">{roomDetails.room_password}</p>
              </div>
            )}
            <p className="text-sm text-muted-foreground">
              ...
              {registrations.map((reg, index) => (
                <div key={reg.id} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">{reg.player_name}</p>
                      <p className="text-sm text-muted-foreground">ID: {reg.player_game_id}</p>
                    </div>
                  </div>
